...
# Add glowing animated header style and background color for the entire app
st.markdown("""
<style>
...
html, body, .css-1v3fvcr, .block-container, .main, .viewerBadge_link {
...
/* 🏷️ Headings */
h1, .stMarkdown h2, .stMarkdown h3 {
